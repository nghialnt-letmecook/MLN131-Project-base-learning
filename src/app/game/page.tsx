...
const galleryImages = [
  ...
  {
    src: "/image/bo-doi-hanh-quan.webp",
  ...
  {
    src: "/image/keo-phao.jpg",
    alt: "Kéo pháo lên đồi tại Điện Biên Phủ",
    label: "Kéo pháo lên đồi tại Điện Biên Phủ",
    file: "keo-phao.jpg",
    pieces: "30 mảnh",
    period: "1953-1954",
    description:
      "Cảnh tượng hùng tráng của bộ đội và dân công kéo pháo lên những sườn đồi dựng đứng, tạo nên thế trận bao vây địch từ trên cao xuống thung lũng Điện Biên Phủ.",
  },
  {
    src: "/image/dao-hao.jpg",
    alt: "Đào hào giao thông tiến công",
    label: "Đào hào giao thông tiến công",
    file: "dao-hao.jpg",
    pieces: "25 mảnh",
    period: "1954",
    description:
      "Hệ thống hào giao thông dài hàng chục kilomet được đào xuyên đêm, giúp bộ đội tiến sát đến từng cứ điểm của địch một cách an toàn và bí mật.",
  },
  {
    src: "/image/doan_xe_dap_tho.webp",
    alt: "Đoàn xe đạp thồ vận chuyển hậu cần",
    label: "Đoàn xe đạp thồ vận chuyển hậu cần",
    file: "doan_xe_dap_tho.webp",
    pieces: "18 mảnh",
    period: "1953-1954",
    description:
      "Đoàn xe đạp thồ chở lương thực, đạn dược qua những con đường rừng núi hiểm trở, thể hiện sức mạnh hậu cần đồng thời là biểu tượng của ý chí chiến thắng.",
  },
  {
    src: "/image/geneve.jpg",
    alt: "Hiệp định Genève 1954",
    label: "Hiệp định Genève 1954",
    file: "geneve.jpg",
    pieces: "15 mảnh",
    period: "1954",
    description:
      "Lễ ký kết Hiệp định Genève ngày 21/7/1954, chính thức công nhận độc lập, chủ quyền của Việt Nam và chấm dứt chiến tranh Đông Dương lần thứ nhất.",
  },
];
