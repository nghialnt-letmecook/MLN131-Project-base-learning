...
const mapPoints: MapPoint[] = [
  {
    ...
    details: "Cứ điểm Him Lam là một trong những vị trí then chốt trong hệ thống phòng thủ của quân Pháp. Được bố trí trên một đồi cao, Him Lam kiểm soát tuyến đường tiếp tế quan trọng. Việc chiếm được cứ điểm này đã tạo ra bước ngoặt quan trọng trong chiến dịch, giúp quân Việt Minh cắt đứt liên lạc giữa các cứ điểm của địch.",
  ...
  },
  {
    ...
    details: "Độc Lập là trung tâm chỉ huy chính của Tướng de Castries và Bộ tư lệnh quân Pháp tại Điện Biên Phủ. Đây là mục tiêu cuối cùng và quan trọng nhất trong chiến dịch. Cứ điểm này được bảo vệ bởi hệ thống công sự kiên cố và là nơi diễn ra những trận đánh quyết liệt cuối cùng của chiến dịch.",
  ...
  },
  {
    ...
    details: "Cứ điểm A1 (tên mã Eliane của Pháp) nằm trên một đồi cao, kiểm soát toàn bộ thung lũng Điện Biên Phủ. Đây là một trong những cứ điểm được tấn công đầu tiên và quyết liệt nhất. Việc chiếm được A1 đã cho phép quân Việt Minh có được vị trí quan sát tuyệt vời và khả năng pháo kích hiệu quả vào các vị trí của địch.",
    image: "/image/a1.jpg",
    video: "/video/a1.mp4"
  },
  {
    ...
    details: "D1 (Dominique) là một trong những cứ điểm được tấn công đầu tiên trong chiến dịch, mở màn cho cuộc tổng tấn công lịch sử. Vị trí này có tầm quan trọng chiến lược cao trong việc kiểm soát phần phía nam của thung lũng và các tuyến đường tiếp tế của quân Pháp.",
    image: "/image/d1.jpg",
    video: "/video/d1.mp4"
  }
];
...
export default function InteractiveMap() {
  ...
  return (
    <section ref={mapRef} className="py-24 px-4 bg-gradient-to-br from-red-50 via-yellow-50 to-red-100 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16 map-title">
          ...
          <p className="text-xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
            Khám phá các cứ điểm chiến lược trong trận chiến lịch sử. 
            Nhấp vào từng điểm đỏ trên bản đồ để tìm hiểu chi tiết về các cứ điểm quan trọng.
          </p>
        </div>
          ...
          <div className="relative w-full aspect-[4/3] bg-gradient-to-br from-green-100 via-yellow-50 to-green-200 rounded-xl overflow-hidden border-2 border-red-200">
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-center text-gray-600">
                ...
                <h3 className="text-2xl font-bold mb-2">Bản đồ Điện Biên Phủ</h3>
                <p className="text-lg">Thung lũng Điện Biên - Nơi diễn ra trận chiến lịch sử</p>
              </div>
            </div>
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-10 left-1/2 transform -translate-x-1/2 bg-red-800 text-yellow-100 text-sm px-3 py-2 rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-all duration-300 shadow-xl border-2 border-yellow-400 max-w-48 text-center">
                    ...
                    <div className="text-xs mt-1 text-yellow-200">{point.description}</div>
                  </div>
                </div>
              </button>
            ))}
            ...
            <div className="absolute bottom-4 right-4 bg-white/95 backdrop-blur-sm rounded-lg p-4 border-2 border-red-200 shadow-lg">
              ...
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-700">Cứ điểm chiến lược</span>
                </div>
                <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm text-gray-700">Dãy núi bao quanh</span>
                </div>
              </div>
            </div>
          </div>
          ...
          >
            <div className="relative">
              ...
              <div className="bg-gradient-to-r from-red-600 to-yellow-500 text-white p-6 rounded-t-2xl">
                <h3 className="text-3xl font-bold mb-2">{selectedPoint.name}</h3>
                <p className="text-lg opacity-90">{selectedPoint.description}</p>
              </div>
                  ...
                  <div>
                    ...
                    <div className="mb-6 h-64 bg-gradient-to-br from-red-100 to-yellow-100 rounded-lg flex items-center justify-center border-2 border-red-200">
                      <div className="text-center text-red-800">
                        ...
                        <p className="text-sm opacity-75">{selectedPoint.name}</p>
                      </div>
                    </div>
                    ...
                    <div className="mt-6 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-r-lg">
                      <h4 className="font-bold text-yellow-800 mb-2">💡 Thông tin thêm</h4>
                      <p className="text-yellow-700 text-sm">
                        Cứ điểm này đóng vai trò quan trọng trong chiến lược tổng thể của chiến dịch Điện Biên Phủ, 
                        góp phần vào thành công chung của cuộc chiến đấu lịch sử này.
                      </p>
                    </div>
                  </div>
                )}
                  ...
                  <div>
                    ...
                    <div className="mb-6 aspect-video bg-gradient-to-br from-red-800 to-yellow-600 rounded-lg flex items-center justify-center text-white">
                      <div className="text-center">
                        ...
                        <h4 className="text-2xl font-bold mb-2">Video Tư Liệu</h4>
                        <p className="text-lg opacity-90 mb-4">{selectedPoint.name}</p>
                    ...
                    <div className="space-y-4">
                      <h4 className="text-xl font-bold text-red-800">Mô tả video</h4>
                      <p className="text-gray-700 leading-relaxed">
                        Tài liệu video quý hiếm về {selectedPoint.name} trong chiến dịch Điện Biên Phủ. 
                        Video bao gồm những hình ảnh lịch sử, lời kể của nhân chứng và phân tích chiến thuật 
                        về tầm quan trọng của cứ điểm này trong tổng thể chiến dịch.
                      </p>
                      
                      <div className="bg-red-50 p-4 rounded-lg">
                        <h5 className="font-bold text-red-800 mb-2">📋 Nội dung chính:</h5>
